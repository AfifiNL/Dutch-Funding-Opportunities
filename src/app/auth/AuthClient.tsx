...
function AuthPageContent() {
  ...
  useEffect(() => {
    if (user) {
      const redirectTo = searchParams?.get('redirectTo') || '/funding';
        ...
        >
          ...
          {(error || formError) && (
            <div className="rounded-md bg-red-50 dark:bg-red-900/50 p-4 border border-red-200 dark:border-red-800">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-red-800 dark:text-red-300">{formError || error}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4 rounded-md shadow-sm">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="relative block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 p-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            ...
            <div className="text-center mt-4">
              <Link href="/" className="text-sm text-gray-600 hover:text-teal-600 dark:text-gray-400 dark:hover:text-teal-400">
                ← Back to home
              </Link>
            </div>
          </form>
